 ...
 * 后序遍历非递归算法
 */
public class PostOrderAntiRecursionStrategy implements IStrategy{

    private final static Logger logger = LoggerFactory.getLogger(PostOrderAntiRecursionStrategy.class);
